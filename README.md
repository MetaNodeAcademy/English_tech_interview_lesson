...
#### 02. 英文自我介绍
- **教学内容（摘要）**：1) 2-minute self-intro 的作用与考察点；2) 开场题设计逻辑；3) Personal Summary 口语化；4) Tell me about yourself / Walk me through your background；5) 常见问题。
- **文档资料地址**：`[待补充]`
- **剪辑之后的视频地址**：`https://appibxs98ig9955.h5.xiaoeknow.com/p/course/video/v_69ef1c6ee4b0694c5bb889c3?product_id=course_36PqayvXTU48GJPgEJonVAde3pf&course_id=course_36PqayvXTU48GJPgEJonVAde3pf&sub_course_id=`
- **状态**：✅

#### 03. 如何用英语讲自己的技术栈和代表项目
- **教学内容（摘要）**：1) 技术栈/项目题作用；2) 项目题考察逻辑；3) 技术栈到业务价值表达；4) 项目介绍标准结构；5) 团队成果与个人贡献区分；6) 常见问题。
- **文档资料地址**：`[待补充]`
- **剪辑之后的视频地址**：`[待补充]`
- **状态**：✅

#### 04. 如何解释技术概念与原理问题
- **教学内容（摘要）**：1) 概念题/原理题作用；2) 概念题考察逻辑；3) 标准结构（是什么/解决什么/如何工作/例子/对比）；4) 复杂概念简化表达；5) 用短句与类比提升清晰度；6) 常见问题。
- **文档资料地址**：`[待补充]`
- **剪辑之后的视频地址**：`[待补充]`
- **状态**：✅

#### 05. 项目深挖、追问与技术决策说明
- **教学内容（摘要）**：1) 深挖题作用；2) 连续追问的考察逻辑；3) 常见追问类型；4) 技术决策与 trade-off 说明；5) linking phrases 提升层次与稳定度；6) 常见问题。
- **文档资料地址**：`[待补充]`
- **剪辑之后的视频地址**：`[待补充]`
- **状态**：✅

#### 06. 行为面试 + HR 面 + 求职动机表达
- **教学内容（摘要）**：1) 行为题/HR 题作用；2) 设计逻辑；3) STAR(R) 回答结构；4) 离职原因/动机/远程偏好表达；5) 体现 ownership、协作与 remote-ready 特质。
- **文档资料地址**：`[待补充]`
- **剪辑之后的视频地址**：`[待补充]`
- **状态**：✅
...
#### 07. 远程敏捷团队第一周落地生存指南
- **教学内容（摘要）**：onboarding 场景、权限申请、敏捷协作基础、ticket 更新、daily stand-up 标准结构。
- **文档资料地址**：`[待补充]`
- **剪辑之后的视频地址**：`[待补充]`
- **状态**：✅

#### 08. Slack / Email / Jira / PR Comment 的工作沟通
- **教学内容（摘要）**：书面沟通工具差异、高质量工作写作标准、四类高频写作场景、Jira 更新核心写法、PR comment 职业化表达。
- **文档资料地址**：`[待补充]`
- **剪辑之后的视频地址**：`[待补充]`
- **状态**：✅

#### 09. Daily standup / status update / blocker 说明
- **教学内容（摘要）**：日常同步作用、Yesterday/Today/Blockers 三段式、信息量升级表达、成熟 blocker 沟通、Web3 & DevOps 高频表达。
- **文档资料地址**：`[待补充]`
- **剪辑之后的视频地址**：`[待补充]`
- **状态**：✅

#### 10. 如何用英语继续学习技术——文档、视频、会议与长期成长
- **教学内容（摘要）**：英语持续学习价值、四大输入场景、高效读文档方法、视频与会议学习法、长期成长系统搭建。
- **文档资料地址**：`[待补充]`
- **剪辑之后的视频地址**：`[待补充]`
- **状态**：✅
